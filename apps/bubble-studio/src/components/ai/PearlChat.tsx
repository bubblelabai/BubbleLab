...
export function PearlChat() {
  ...
  return (
    <div className="h-full flex flex-col">
        ...
        {pearl.messages.length === 0 && !pearl.isPending && (
          <div className="flex flex-col items-center justify-center h-full px-4 py-8">
            ...
            <div className="w-full max-w-sm space-y-2.5">
              <div className="text-[10px] font-bold text-gray-600 uppercase tracking-[0.2em] mb-3 px-1 text-center">
                Quick Actions
              </div>
              {getQuickStartSuggestions().map((suggestion, index) => (
                <button
                  ...
                  className="group w-full px-4 py-3 bg-[#1a1a1a] hover:bg-[#202020] border border-white/5 hover:border-white/10 rounded-xl text-left transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5"
                >
                  <div className="flex items-start gap-3">
                    <div className="flex-shrink-0 mt-0.5 p-1.5 bg-white/5 rounded-lg text-gray-400 group-hover:text-gray-300 transition-colors">
                      {suggestion.icon}
                    </div>
                    <div className="flex-1 min-w-0 py-0.5">
                      ...
                      <div className="text-xs text-gray-500 group-hover:text-gray-400 transition-colors line-clamp-1">
            ...
            <div key={message.id}>
              {message.type === 'user' ? (
                ...
                <div className="p-3 flex justify-end">
                  <div className="bg-[#2a2a2a] border border-white/5 rounded-2xl rounded-tr-sm px-4 py-3 max-w-[85%] shadow-sm">
      ...
      <div className="flex-shrink-0 p-4 pt-2 bg-gradient-to-t from-[#0a0a0a] to-transparent">
        <div className="bg-[#1a1a1a] border border-white/10 rounded-2xl p-3 shadow-2xl relative focus-within:border-purple-500/30 focus-within:ring-1 focus-within:ring-purple-500/30 transition-all duration-300">
          {uploadError && (
              ...
              {uploadedFiles.map((file, index) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="p-0.5 hover:bg-white/10 rounded transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0"
          ...
          <div className="relative">
            <BubblePromptInput
              ...
              placeholder="Ask Pearl to modify your flow..."
              className="bg-transparent text-gray-100 text-sm w-full placeholder-gray-500 resize-none focus:outline-none focus:ring-0 p-0 pr-10 leading-relaxed"
              disabled={pearl.isPending}
              flowId={selectedFlowId}
