...
export class BubbleLogger {
  ...
  /**
   * Add token usage to cumulative tracking
   */
  addTokenUsage(tokenUsage: TokenUsage): void {
    this.cumulativeTokenUsage.inputTokens += tokenUsage.inputTokens;
    this.cumulativeTokenUsage.outputTokens += tokenUsage.outputTokens;
    this.cumulativeTokenUsage.totalTokens += tokenUsage.totalTokens;
  }
  ...
  logTokenUsage(
    ...
    this.info(logMessage, {
      ...
      additionalData: {
        ...
        tokenUsage,
        cumulativeTokenUsage: this.getTokenUsage(),
      },
    });
