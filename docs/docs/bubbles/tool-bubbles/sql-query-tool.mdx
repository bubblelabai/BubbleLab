...
const result = await new SQLQueryTool({
  ...
  reasoning: 'Get recent signups for weekly report.',
  credentials: {
...
<dt>
  <code>reasoning</code> <em>string</em>{' '}
  <span style={{ color: '#d32f2f', fontWeight: 600 }}>required</span>
</dt>
<dd>
  Explain why you're running this specific query and what you hope to learn from
  it
</dd>
