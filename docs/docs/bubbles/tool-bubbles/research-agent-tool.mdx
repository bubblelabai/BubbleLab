...
<dl>
  ...
  <dt><code>model</code> <em>'openai/gpt-5' | 'openai/gpt-5-mini' | 'openai/gpt-5.1' | 'google/gemini-2.5-pro' | 'google/gemini-2.5-flash' | 'google/gemini-2.5-flash-lite' | 'google/gemini-2.5-flash-image-preview' | 'google/gemini-3-pro-preview' | 'anthropic/claude-sonnet-4-5' | 'anthropic/claude-haiku-4-5' | 'openrouter/x-ai/grok-code-fast-1' | 'openrouter/z-ai/glm-4.6' | 'openrouter/morph/morph-v3-large' | 'openrouter/deepseek/deepseek-chat-v3.1'</em> </dt>
