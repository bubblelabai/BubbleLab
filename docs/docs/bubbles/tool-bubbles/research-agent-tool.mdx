...
<dt>
  <code>expectedResultSchema</code> <em>string</em>{' '}
  <span style={{ color: '#d32f2f', fontWeight: 600 }}>required</span>
</dt>
<dd>
  JSON schema string that defines the expected structure of the research result
</dd>

<dt>
  <code>model</code>{' '}
  <em>
    'openai/gpt-5' | 'openai/gpt-5-mini' | 'openai/gpt-o4-mini' |
    'google/gemini-2.5-pro' | 'google/gemini-2.5-flash' |
    'google/gemini-2.5-flash-lite' | 'google/gemini-2.5-flash-image-preview'
  </em>{' '}
</dt>
<dd>Model to use for the research agent (default: google/gemini-2.5-flash)</dd>

<dt>
  <code>maxTokens</code> <em>number</em>{' '}
</dt>
...
<div className="schema-card">
<dl>
  <dt><code>result</code> <em>Record&lt;string,unknown&gt;</em> <span style={{color:'#d32f2f',fontWeight:600}}>required</span></dt>
...
<dt>
  <code>sourcesUsed</code> <em>string[]</em>{' '}
  <span style={{ color: '#d32f2f', fontWeight: 600 }}>required</span>
</dt>
<dd>
...
<dt>
  <code>iterationsUsed</code> <em>number</em>{' '}
  <span style={{ color: '#d32f2f', fontWeight: 600 }}>required</span>
</dt>
