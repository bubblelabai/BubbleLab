...
<dt>
  <code>alias</code> <em>string</em>{' '}
</dt>
<dd>Short alias for the bubble</dd>

<dt>
  <code>longDescription</code> <em>string</em>{' '}
  <span style={{ color: '#d32f2f', fontWeight: 600 }}>required</span>
</dt>
<dd>Detailed description of the bubble functionality</dd>

<dt>
  <code>usageExample</code> <em>string</em>{' '}
  <span style={{ color: '#d32f2f', fontWeight: 600 }}>required</span>
</dt>
